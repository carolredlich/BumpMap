...
void SphereShader::loadVariables( )
{
    ...
    glUniform4f( parameterLightAmbient, _lightAmbient[0], _lightAmbient[1], _lightAmbient[2], _lightAmbient[3] );

    unsigned int parameterLightSpecular = glGetUniformLocation( _glShader, "lightSpecular" );
    glUniform4f( parameterLightSpecular, _lightSpecular[0], _lightSpecular[1], _lightSpecular[2], _lightSpecular[3] );
